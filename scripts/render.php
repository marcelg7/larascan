...
function loadBrandConfig(): array
{
    ...
    $candidates = [
        ...
        __DIR__ . '/../config.json',
        ($_SERVER['HOME'] ?? '') . '/.config/larascan/config.json',
    ];
...
<head>
<meta charset="utf-8">
<title>Larascan — <?= e($repoName) ?></title>
<style>
  @page { margin: 20mm; }
...
<?php endforeach; endif; ?>
  ...
  <footer>
    <div class="generator">
      Generated by <?= e($meta['scanner'] ?? 'larascan') ?> &middot; automated scan, not a substitute for a human code review.
    </div>
